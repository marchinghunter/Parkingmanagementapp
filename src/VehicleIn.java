...
public class VehicleIn extends javax.swing.JFrame {
   ...
   private String ownerNameString;
    ...
    private void initComponents() {
        ...
        vehicleInbtn.setFont(new java.awt.Font("Consolas", 1, 28)); // NOI18N
        ...
        vehicleTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "S.NO", "Parking No.", "Owner Name", "Vehicle Company", "Registration Number", "Owner Contact no.", "Parking Time"
            }
        ) {
    ...
    private void entryinDb() throws Exception{
        ...
        while(set.next()){
            ...
            if(set.getString("Status")==null){
                Object [] data = {i,set.getInt(1),set.getString(5),set.getString(3),set.getString(4),set.getString(6),set.getString(7)};
        dtm.addRow(data);
        i++;
            }
            else{
